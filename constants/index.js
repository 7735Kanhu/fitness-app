export const rapidApiKey ='28dac93bb2msh74d77bdea82b4c8p12144djsndeb34e670f75'
import { Asset } from 'expo-asset';

export const sliderImages = [
  Asset.fromModule(require('../assets/images/slide1.png')).uri,
  Asset.fromModule(require('../assets/images/slide2.png')).uri,
  Asset.fromModule(require('../assets/images/slide3.png')).uri,
  Asset.fromModule(require('../assets/images/slide4.png')).uri,
  Asset.fromModule(require('../assets/images/slide5.png')).uri,
];
